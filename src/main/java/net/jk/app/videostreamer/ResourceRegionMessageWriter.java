...
public class ResourceRegionMessageWriter implements HttpMessageWriter<ResourceRegion> {
	...
	@Override
	public Mono<Void> write(Publisher<? extends ResourceRegion> inputStream, ResolvableType elementType,
							...
							try {
								...
								e.printStackTrace();
				                    ...
				                    .orElseGet(()->{
				                        ...
				                        var body = this.regionEncoder.encode(input, response.bufferFactory(), REGION_TYPE, resourceMediaType, Collections.emptyMap());
	...
	public Optional<Mono<Void>> zeroCopy(Resource resource, ResourceRegion region, ReactiveHttpOutputMessage message) {
